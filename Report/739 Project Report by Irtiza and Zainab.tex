...
\begin{figure}[H]
  ...
  \caption{\textbf{Min latency(ms) is independent of number of instances or users. We notice an outlier case for 4 instances with 100 simulated users}}
\label{fig:min_latency}
\end{figure}
\begin{figure}[H]
  \centering
      \includegraphics[scale=0.75]{Images/max_latency.PNG}
  \caption{\textbf{Max latency(ms) increases with an in number of instances and users } }
